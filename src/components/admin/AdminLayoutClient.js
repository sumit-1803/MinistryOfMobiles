...
export default function AdminLayoutClient({ children }) {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex">
      ...
      {/* Sidebar */}
      <div className={`
        fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-md transform transition-transform duration-200 ease-in-out md:translate-x-0 md:static md:inset-auto
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        {/* Mobile Header */}
        <div className="md:hidden bg-white shadow-sm p-4 flex items-center border-b">
          <button
