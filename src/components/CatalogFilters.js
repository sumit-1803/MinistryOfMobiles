    ...
    <div className="lg:sticky lg:top-24">
      ...
      <div className="lg:hidden mb-6">
        <button 
          ...
          className="w-full flex items-center justify-center gap-2 bg-white border border-gray-200 text-gray-900 font-medium py-3 px-4 rounded-xl shadow-sm"
        >
      ...
      {/* Filter Container (Sidebar on Desktop, Drawer on Mobile) */}
      <div className={`
        bg-white/60 backdrop-blur-xl border border-white/20 shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6
        lg:rounded-3xl lg:block
        fixed inset-y-0 right-0 z-50 w-80 bg-white transform transition-transform duration-300 ease-in-out lg:static lg:w-auto lg:transform-none lg:inset-auto
      ...
      `}>
        ...
        <form onSubmit={applyFilters} className="space-y-8 h-[calc(100vh-140px)] lg:h-auto overflow-y-auto lg:overflow-visible pr-2 lg:pr-0">
          {/* Search */}
